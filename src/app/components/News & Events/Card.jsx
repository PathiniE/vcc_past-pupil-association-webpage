...
//             <CardDescription className="text-gray-600">Join us for an exciting orientation to kick off the semester !
//             <Link
//                 href={'/projects'}
...
//             <CardDescription className="text-gray-600">Make a difference by volunteering in our community events this spring !
//             <Link
//                 href={'/projects'}
//                 className="text-primary hover:font-bold flex items-center text-sm gap-2 mt-2"
//               >
